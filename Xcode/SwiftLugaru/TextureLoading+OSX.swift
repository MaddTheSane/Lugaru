...
func loadTexture(fileURL: NSURL, inout textureID: GLuint, mipmap: Int32, hasAlpha: Bool) {
	...
	do {
		...
		//gluBuild2DMipmaps( GLenum(GL_TEXTURE_2D), type, GLsizei(imgRep.pixelsWide), GLsizei(imgRep.pixelsHigh), GLenum(imgRep.alpha ? GL_RGBA : GL_RGB), GLenum(GL_UNSIGNED_BYTE), imgRep.bitmapData );
